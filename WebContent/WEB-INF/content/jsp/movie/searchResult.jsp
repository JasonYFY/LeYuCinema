	...
	<div class="area-cont">
		<div class="area-main fl" style="height: 500px">
			<ul class="area-menu fl clearfix">
					...
					<!-- 遍历显示 -->
					<s:iterator value="searchList" var="item" status="i">
						<li class="area-menu__item" >
							...
							<div class="info" style="height: 110px">
								...
								<font class="userName">用户:<s:property value="#item.uploader.nickName" /><br>
