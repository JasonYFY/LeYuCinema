	...
	<div id="header">
		...
		<div class="header-top">
			<div class="auto-width">
				...
				<div class="search-box fl">
						...
						<button  id="send" class="fl search-btn">
		...
		<div class="header-nav">
			<div class="nav-wrap auto-width clearfix">
				...
				<iframe id="sr"  frameborder="0" name="searchResult" src="${pageContext.request.contextPath}/searchResult" marginheight="0" 
				marginwidth="0" scrolling="no" width="100%" height="560px" >
...
$("#send").click(function(){
	...
	window.frames["searchResult"].document.getElementById('name').value=name;
	window.frames["searchResult"].document.getElementById('movieForm').submit();
});


$(function(){
	var a = true;
	window.document.getElementById('sr').onload=function(){
		if(a){
			var name = document.getElementById('name').value;
			window.frames["searchResult"].document.getElementById('name').value=name;
			window.frames["searchResult"].document.getElementById('movieForm').submit();
