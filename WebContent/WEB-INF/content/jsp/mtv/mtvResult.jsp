...
<section class="area clearfix area-recommend" style="margin: 10px 30px;"> 
				...
				<s:form action="mtv_result" id="mtvForm">
	...
	<div class="area-cont">
		<div class="area-main fl" style="height: 500px">
			<ul class="area-menu fl clearfix">
					...
					<!-- 遍历显示 -->
					<s:iterator value="mtvList" var="item" status="i">
						<li class="area-menu__item" >
							...
							<div class="info" style="height: 110px">
								...
								<font class="userName">
									<p>UP主:<s:property value="#item.uploader.nickName" /></p>
									<p>播放:<s:property value="#item.playTimes" /></p>
									<p>发布:<s:date name="#item.createDate" format="yyyy-MM-dd"/></p>
								</font>
							</div>
						</li>
					</s:iterator>
