...
<jsp:include page="../quoteTop.jsp"></jsp:include>
	...
	<iframe id="mtvR"  frameborder="0" name="mtvResult" src="${pageContext.request.contextPath}/mtv_result" marginheight="0" 
	marginwidth="0" scrolling="no" width="100%" height="550px" >
