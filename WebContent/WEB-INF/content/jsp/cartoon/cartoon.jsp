...
<jsp:include page="../quoteTop.jsp"></jsp:include>
	...
	<iframe id="cartoonR"  frameborder="0" name="cartoonResult" src="${pageContext.request.contextPath}/cartoon_result" marginheight="0" 
...
$(function(){
	...
	$('#cartoon').addClass('nav-item nav-cur');
